...
$dominioServer = "https://raw.githubusercontent.com/castsab/JsonIDT/master";
...
while ($rw = mysqli_fetch_array($rs)) {
    ...
    while ($row = mysqli_fetch_array($rss)) {
        ...
        $rgb = $bd->getObtenerRgbImagen($row['ICONO']);
        $COLOR_FILA = $bd->getRgbConvertirAHexadecimal($rgb);
        
        $rgb_fondo = $bd->getObtenerRgbImagenFondo($row['ICONO']);
        ...
        $a_tipologias[$rw['CODIGO']][$j]['ICONO'] = utf8_encode($dominioServer."".$row['ICONO']);
        $a_tipologias[$rw['CODIGO']][$j]['IMAGEN'] = utf8_encode($dominioServer."".$row['IMAGEN']);
        
        $a_tipologias[$rw['CODIGO']][$j]['TIENE_SUBTIPOLOGIA'] = $row['TIENE_SUBTIPOLOGIA'];
        
        $a_tipologias[$rw['CODIGO']][$j]['backgroundColor'] = $COLOR_FILA;
        
        $a_tipologias[$rw['CODIGO']][$j]['RUTA_TRIANGULO'] = utf8_encode($dominioServer."/imagenes/".$nombreImagenTriangulo);
...
fwrite($file, json_encode($a_tipologias));
//------------------------------------------
//------------------------------------------
...
while ($rw = mysqli_fetch_array($rs)) {
    ...
    while ($row = mysqli_fetch_array($rss)) {
        ...
        $a_subtipologias[$rw['CODIGO']][$j]['IMAGEN'] = utf8_encode($dominioServer."".$row['IMAGEN']);
...
fwrite($file, json_encode($a_subtipologias));
//------------------------------------------
//------------------------------------------
...
while ($rw = mysqli_fetch_array($rs)) {
    ...
    $a_zonas[$i]['IMAGEN'] = utf8_encode($dominioServer."".$rw['IMAGEN']);
    ...
    $a_zonas[$i]['RUTA_TRIANGULO'] = utf8_encode($dominioServer."/imagenes/".$nombreImagenTriangulo);
...
fwrite($file, json_encode($a_zonas));
//------------------------------------------
//------------------------------------------
...
while ($rw = mysqli_fetch_array($rs)) {
    ...
    while ($row = mysqli_fetch_array($rss)) {
        ...
        $a_zonas_tipologias[$rw['CODIGO']][$j]['ICONO'] = utf8_encode($dominioServer."".$row['ICONO']);
        $a_zonas_tipologias[$rw['CODIGO']][$j]['IMAGEN'] = utf8_encode($dominioServer."".$row['IMAGEN']);
        ...
        $a_zonas_tipologias[$rw['CODIGO']][$j]['RUTA_TRIANGULO'] = utf8_encode($dominioServer."/imagenes/".$nombreImagenTriangulo);
...
fwrite($file, json_encode($a_zonas_tipologias));
//------------------------------------------
//------------------------------------------
...
while ($rw = mysqli_fetch_array($rs)) {
    ...
    while ($row = mysqli_fetch_array($rss)) {
        ...
        $a_prestadores_subtipologias[$rw['CODIGO']][$j]['IMAGEN'] = utf8_encode($dominioServer."".$img_prestador);
        ...
        if(!empty($IMAGEN))
        {
            for ($i = 0; $i < sizeof($IMAGEN); $i++) {
                $a_prestadores_subtipologias[$rw['CODIGO']][$j]['FOTOS'][$i] = utf8_encode($dominioServer."".$IMAGEN[$i]);
            }
        }
        else
        {
...
fwrite($file, json_encode($a_idiomas));
